...
'''
python3 batchMergerOneHot.py --indir 2023_12_13_NtuplesV56/Input2/JetMET_PuppiJet_BarrelEndcap_Pt30_HoTot70 \
    --batchdir GoodNtuples --v HCAL --odir DataRecoOneHot --filesPerRecord 50 --selectResp --fix_stats 100000 \
