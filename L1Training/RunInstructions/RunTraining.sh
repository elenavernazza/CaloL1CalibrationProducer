...
# constrain zero suppression in the barrel and SFs for 1 to always be <= 1
...
# constrain zero suppression in the barrel and SFs for 1 and 2  to always be <= 2
python3 NNModel_RegAndRate_5.py --indir 2023_12_05_NtuplesV54/JetMET_PuppiJet_BarrelEndcap_Pt30_HoTot95 \
    --v HCAL --tag DataReco --MaxLR 1E-4 --addtag _Test5 --batch_size 256 --epochs 20 --ThrRate 40 --TargetRate 0.33569892616499036
python3 ProgressionSFs.py --indir 2023_12_05_NtuplesV54/JetMET_PuppiJet_BarrelEndcap_Pt30_HoTot95 --v HCAL --tag DataReco --addtag _Test5 --epochs 20
python3 ProgressionPerformance.py --indir 2023_12_05_NtuplesV54/JetMET_PuppiJet_BarrelEndcap_Pt30_HoTot95 --v HCAL --tag DataReco --addtag _Test5 --epochs 20 \
    --set Test --eventLim 20000 (--FromDF)

# constrain zero suppression in the barrel and SFs for 1 and 2  to always be <= 2.1
python3 NNModel_RegAndRate_6.py --indir 2023_12_05_NtuplesV54/JetMET_PuppiJet_BarrelEndcap_Pt30_HoTot95 \
    --v HCAL --tag DataReco --MaxLR 1E-4 --addtag _Test6 --batch_size 256 --epochs 20 --ThrRate 40 --TargetRate 0.33569892616499036
python3 ProgressionSFs.py --indir 2023_12_05_NtuplesV54/JetMET_PuppiJet_BarrelEndcap_Pt30_HoTot95 --v HCAL --tag DataReco --addtag _Test6 --epochs 20
python3 ProgressionPerformance.py --indir 2023_12_05_NtuplesV54/JetMET_PuppiJet_BarrelEndcap_Pt30_HoTot95 --v HCAL --tag DataReco --addtag _Test6 --epochs 20 \
    --set Test --eventLim 20000 (--FromDF)
...
# constrain SFs for iEt in [1,9] to always be <= 1.01
python3 NNModel_RegAndRate_7.py --indir 2023_12_10_NtuplesV55/JetMET_PuppiJet_BarrelEndcap_Pt30_HoTot70_MinusIem \
    --v HCAL --tag DataReco_200 --MaxLR 1E-4 --batch_size 1024 --epochs 20 --ThrRate 40 --TargetRate 0.15787546798164545 --addtag Test7
python3 ProgressionSFs.py --indir 2023_12_10_NtuplesV55/JetMET_PuppiJet_BarrelEndcap_Pt30_HoTot70_MinusIem --v HCAL --tag DataReco_200 --addtag Test7 --epochs 20
python3 ProgressionPerformance.py --indir 2023_12_10_NtuplesV55/JetMET_PuppiJet_BarrelEndcap_Pt30_HoTot70_MinusIem --v HCAL --tag DataReco_200 --addtag Test7 --epochs 20 \
...
python3 PrepareReEmulation.py --indir 2023_12_05_NtuplesV54/JetMET_PuppiJet_BarrelEndcap_Pt30_HoTot95 \
    --v HCAL --tag DataReco --addtag _Test6 --applyECAL False --modelRate

python3 ProduceCaloParams.py --name caloParams_2023_v51_Test6_newCalib_cfi \
    --base caloParams_2023_v0_2_noL1Calib_cfi.py \
    --HCAL /data_CMS/cms/motta/CaloL1calibraton/2023_12_05_NtuplesV54/JetMET_PuppiJet_BarrelEndcap_Pt30_HoTot95/HCALtrainingDataReco/data_Test6/ScaleFactors_HCAL_energystep2iEt.csv

cmsenv
voms
python submitOnTier3.py --inFileList JetMET__Run2022G-PromptReco-v1__Run362617__AOD \
    --outTag GT130XdataRun3Promptv3_CaloParams2023v51Test6_data_reco_json \
    --nJobs 31 \
    --queue short \
    --maxEvts 5000 \
    --inJson Cert_Collisions2022_355100_362760_Golden \
    --caloParams caloParams_2023_v51_Test6_newCalib_cfi \
    --globalTag 130X_dataRun3_Prompt_v3 \
    --data \
    --recoFromAOD
python submitOnTier3.py --inFileList EphemeralZeroBias0__Run2022G-v1__Run362617__RAW \
    --outTag GT130XdataRun3Promptv3_CaloParams2023v51Test6_data \
    --nJobs 31 \
    --queue short \
    --maxEvts 5000 \
    --caloParams caloParams_2023_v51_Test6_newCalib_cfi \
...
python3 resolutions.py --indir JetMET__Run2022G-PromptReco-v1__Run362617__AOD__GT130XdataRun3Promptv3_CaloParams2023v51Test6_data_reco_json \
 --outdir 2023_12_05_NtuplesV54/JetMET_PuppiJet_BarrelEndcap_Pt30_HoTot95_CaloParams2023v51Test6 --label Muon_data_reco --reco --nEvts 100000 --target jet --raw --PuppiJet --etacut 3 --jetPtcut 30 --do_HoTot
python3 turnOn.py --indir JetMET__Run2022G-PromptReco-v1__Run362617__AOD__GT130XdataRun3Promptv3_CaloParams2023v51Test6_data_reco_json \
 --outdir 2023_12_05_NtuplesV54/JetMET_PuppiJet_BarrelEndcap_Pt30_HoTot95_CaloParams2023v51Test6 --label Muon_data_reco --reco --nEvts 100000 --target jet --raw --PuppiJet --jetPtcut 15 --er 1.305
python3 rate.py --indir EphemeralZeroBias0__Run2022G-v1__Run362617__RAW__GT130XdataRun3Promptv3_CaloParams2023v51Test6_data \
 --outdir 2023_12_05_NtuplesV54/JetMET_PuppiJet_BarrelEndcap_Pt30_HoTot95_CaloParams2023v51Test6 --label Muon_data_reco --nEvts 100000 --target jet --raw --er 1.305
python3 comparisonPlots.py --indir 2023_12_05_NtuplesV54/JetMET_PuppiJet_BarrelEndcap_Pt30_HoTot95_CaloParams2023v51Test6 --label Muon_data_reco  --target jet --reco \
 --thrsFixRate 35 --thrsFixRate 40 --thrsFixRate 45 --thrsFixRate 50 --thrsFixRate 60 --thrsFixRate 80 \
 --old 2023_12_05_NtuplesV54/NtuplesVcur_Raw_Puppi_BarrelEndcap_Pt30 --unc 2023_12_05_NtuplesV54/NtuplesVunc_Raw_Puppi_BarrelEndcap_Pt30 --do_HoTot --er 1.305
