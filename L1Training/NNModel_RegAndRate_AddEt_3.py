# Regression term is weighted by offline energy (linear)
# Saturation of scale factors
...
if __name__ == "__main__" :
    ...
    with mirrored_strategy.scope():
        ...
        def regressionLoss(y, y_pred, other):
            ...
            weight = y
            return weight * tf.reshape(MAPE(y, Total_ET), (1, 1)) * float(options.regr_w) # FIXME: scaling to be defined
