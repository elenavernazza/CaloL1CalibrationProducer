...
if __name__ == "__main__" :
    ...
    with mirrored_strategy.scope():
        ...
        def saturationLoss():
            ...
            #         pred_energy = TTP(one_hot_tower_reshaped)
            #         SF = pred_energy/i_energy
            #         modelSaturation += threshold_relaxation_sigmoid(SF, 2 + 0.05, 1000) * float(options.satu_w)
        ...
        def compute_losses(y, y_pred, other, z, z_pred):
            ...
            # can we optimize by maximizing the integral of the turn on?å
            # TurnOnLoss_value = TurnOnLoss()
