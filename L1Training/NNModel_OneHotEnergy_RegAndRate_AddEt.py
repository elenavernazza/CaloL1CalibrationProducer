...
'''
python3 NNModel_OneHotEnergy_RegAndRate_AddEt.py --indir 2023_12_13_NtuplesV56/Input2/JetMET_PuppiJet_BarrelEndcap_Pt30_HoTot70 \
--v HCAL --tag DataRecoOneHot --addtag _TestOneHot --epochs 10 --regr_w 50 --weig_w 1 --rate_w 1 --satu_w 10 --MaxLR 1e-04 --batch_size 256 --ThrRate 40

python3 NNModel_OneHotEnergy_RegAndRate_AddEt.py --indir 2023_12_13_NtuplesV56/Input2/JetMET_PuppiJet_BarrelEndcap_Pt30_HoTot70 \
--v HCAL --tag DataRecoOneHot --addtag _TestOneHot_A --epochs 10 --regr_w 50 --weig_w 1 --rate_w 1 --satu_w 10 --MaxLR 1e-03 --batch_size 256 --ThrRate 40

python3 NNModel_OneHotEnergy_RegAndRate_AddEt.py --indir 2023_12_13_NtuplesV56/Input2/JetMET_PuppiJet_BarrelEndcap_Pt30_HoTot70 \
--v HCAL --tag DataRecoOneHot --addtag _TestOneHot_B --epochs 10 --regr_w 50 --weig_w 0.01 --rate_w 1 --satu_w 10 --MaxLR 1e-03 --batch_size 256 --ThrRate 40

python3 NNModel_OneHotEnergy_RegAndRate_AddEt.py --indir 2023_12_13_NtuplesV56/Input2/JetMET_PuppiJet_BarrelEndcap_Pt30_HoTot70 \
--v HCAL --tag DataRecoOneHot --addtag _TestOneHot_C --epochs 50 --regr_w 50 --weig_w 0.01 --rate_w 1 --satu_w 10 --MaxLR 1e-04 --batch_size 256 --ThrRate 40

python3 NNModel_OneHotEnergy_RegAndRate_AddEt.py --indir 2023_12_13_NtuplesV56/Input2/JetMET_PuppiJet_BarrelEndcap_Pt30_HoTot70 \
--v HCAL --tag DataRecoOneHot --addtag _TestOneHot_D --epochs 20 --regr_w 50 --weig_w 0.0001 --rate_w 1 --satu_w 10 --MaxLR 1e-03 --batch_size 256 --ThrRate 40 (middle layer initializer Ones)

python3 NNModel_OneHotEnergy_RegAndRate_AddEt.py --indir 2023_12_13_NtuplesV56/Input2/JetMET_PuppiJet_BarrelEndcap_Pt30_HoTot70 \
--v HCAL --tag DataRecoOneHotMaskLowEnergy --addtag _TestOneHotMaskLowEnergy_A --epochs 20 --ThrRate 40 \
--regr_w 50 --weig_w 0.0001 --rate_w 1 --satu_w 10 --MaxLR 1e-03 --batch_size 256

python3 NNModel_OneHotEnergy_RegAndRate_AddEt.py --indir 2023_12_13_NtuplesV56/Input2/JetMET_PuppiJet_BarrelEndcap_Pt30_HoTot70 \
--v HCAL --tag DataRecoOneHotMaskLowEnergy --addtag _TestOneHotMaskLowEnergy_B --epochs 20 --ThrRate 40 \
--regr_w 50 --weig_w 0.0001 --rate_w 1 --satu_w 10 --MaxLR 1e-03 --batch_size 256 --LRscheduler
...
python3 NNModel_OneHotEnergy_RegAndRate_AddEt.py --indir 2023_12_13_NtuplesV56/Input2/JetMET_PuppiJet_BarrelEndcap_Pt30_HoTot70 \
--v HCAL --tag DataRecoOneHotMaskLowEnergy --addtag _TestOneHotMaskLowEnergy_C --epochs 20 --ThrRate 40 \
--regr_w 50 --weig_w 0.0001 --rate_w 0.1 --satu_w 10 --MaxLR 1e-03 --batch_size 256 --LRscheduler

# correct inputs
python3 NNModel_OneHotEnergy_RegAndRate_AddEt.py --indir 2023_12_13_NtuplesV56/Input2/JetMET_PuppiJet_BarrelEndcap_Pt30_HoTot70 \
--v HCAL --tag DataRecoOneHotMaskLowEnergy --addtag _TestOneHotMaskLowEnergy_D --epochs 20 --ThrRate 40 \
--regr_w 50 --weig_w 0.0001 --rate_w 1 --satu_w 10 --MaxLR 1e-03 --batch_size 256

python3 NNModel_OneHotEnergy_RegAndRate_AddEt.py --indir 2023_12_13_NtuplesV56/Input2/JetMET_PuppiJet_BarrelEndcap_Pt30_HoTot70 \
--v HCAL --tag DataRecoOneHotMaskLowEnergy --addtag _TestOneHotMaskLowEnergy_E --epochs 20 --ThrRate 40 \
--regr_w 10 --weig_w 0.0001 --rate_w 0 --satu_w 10 --MaxLR 1e-03 --batch_size 256
'''
...
def create_model(version, seedThr=None):
    ...
    TTP_input = keras.Input(shape=(81,240), dtype=tf.float32, name='chunky_donut')
    
    # layer1 = Dense(82,   name='nn1', input_dim=239, activation='relu', kernel_initializer=RN(seed=7), use_bias=False)
    # layer2 = Dense(8000, name='nn2',                activation='relu', kernel_initializer=RN(seed=7), use_bias=False)
    # layer3 = Dense(1,    name='nn3',                activation='relu', kernel_initializer=RN(seed=7), use_bias=False)

    layer1 = Dense(82,   name='nn1', input_dim=239, activation='relu', kernel_initializer=RN(seed=7), use_bias=False)
    layer2 = Dense(8000, name='nn2',                activation='relu', kernel_initializer=Ones, use_bias=False)
    layer3 = Dense(1,    name='nn3',                activation='relu', kernel_initializer=RN(seed=7), use_bias=False)
    ...
    rate_input = keras.Input(shape=(81,240), dtype=tf.float32, name='rate_proxy')
    ...
    if version == 'ECAL':
        ...
        eg_had     = lay.Lambda(lambda x : tf.reduce_sum(x, axis=1, keepdims=True)[:,:,0:1], name='eg_had_deposit')(rate_input)
        eg_em_     = make_AddList(TTP, rate_input, name="rate_")
        eg_em      = lay.Add(name="eg_em_deposit")(eg_em_)
        rate_output = lay.Lambda(lambda x : x[0] + x[1], name="eg_tot_energy")((eg_em, eg_had))
        # The rate_output is a vector of calibrated L1 jet energies !!! only for jets passing the seed threshold !!!

    model = keras.Model(inputs=[TTP_input, rate_input], outputs=[TTP_output, rate_output, OtherET], name='Layer1Calibrator')
...
if __name__ == "__main__" :
    ...
    with mirrored_strategy.scope():
        ...
        #             modelSaturation += threshold_relaxation_sigmoid(SF, 1.5 + 0.05, 1000) * float(options.satu_w)
        ...
        def compute_losses(y, y_pred, other, z, z_pred):
            ...
            saturationLoss_value = 0

            fullLoss = regressionLoss_value + weightsLoss_value + rateLoss_value + saturationLoss_value
    ...
    def custom_test_step(inputs, rate_inputs):
        x, y = inputs
        z, _ = rate_inputs
        y_pred, z_pred, other = model([x, z], training=False)
        losses = compute_losses(y, y_pred, other, z, z_pred)
    ...
    for epoch in range(EPOCHS):
        ...
        for batch, rate_batch in zip(train_dist_dataset, rate_dist_dataset):
            ...
            if VERBOSE and num_batches % 1 == 0:
                print(' ***** At batch %d (seen %d samples so far) : loss = %.4f ; regressionLoss = %.4f ; weightsLoss = %.4f ; rateLoss = %.4f ; RMSE = %.4f'
        ...
        print('Training : loss = %.4f ; regressionLoss = %.4f ; weightsLoss = %.4f ; rateLoss = %.4f ; RMSE = %.4f' 
            % (float(train_losses_avg[0]), float(train_losses_avg[1]), 
               float(train_losses_avg[2]), float(train_losses_avg[3]), 
               float(train_RMSE)) )
        print('Testing  : loss = %.4f ; regressionLoss = %.4f ; weightsLoss = %.4f ; rateLoss = %.4f ; RMSE = %.4f' 
