...
if not options.plot_only:
    ...
    if options.er:
        ptProgression0er0p0 = filein.Get('ptProgression0er0p0')
        ptDiProgression0er0p0 = filein.Get('ptDiProgression0er0p0')
        rateProgression0er0p0 = filein.Get('rateProgression0er0p0')
        rateDiProgression0er0p0 = filein.Get('rateDiProgression0er0p0')
